...
public class GetPartialDerivativeFunctionOnZForFunction4x1Task extends Orion
{
    ...
    public static Function4x1<ANumber, ANumber, ANumber, ANumber, ANumber> run(Function4x1<ANumber, ANumber, ANumber, ANumber, ANumber> f, int precision, int orderOfDerivative)
    {
        ...
        else
        {
            ...
            return run(f, x, y, w, precision, orderOfDerivative);
        }

    }


    public static Function4x1<ANumber, ANumber, ANumber, ANumber, ANumber> run(Function4x1<ANumber, ANumber, ANumber, ANumber, ANumber> f, ANumber x, ANumber y, ANumber w)
    {
        return run(f, x, y, w, Precision.precision);
    }


    public static Function4x1<ANumber, ANumber, ANumber, ANumber, ANumber> run(Function4x1<ANumber, ANumber, ANumber, ANumber, ANumber> f, ANumber x, ANumber y, ANumber w, int precision)
    {
        return run(f, x, y, w, precision, 1);
    }


    public static Function4x1<ANumber, ANumber, ANumber, ANumber, ANumber> run(Function4x1<ANumber, ANumber, ANumber, ANumber, ANumber> f, ANumber x, ANumber y, ANumber w, int precision, int orderOfDerivative)
    {
        FunctionRules.isValid(f);
        NumberRules.areNotNull(x, y, w);
        DifferentiationRules.isValid(orderOfDerivative);

        if(f.getIndicesOfVariablesThatAreConstants()[2])
        {
            Function4x1IF<ANumber, ANumber, ANumber, ANumber, ANumber> function = (ANumber x1, ANumber y1, ANumber z, ANumber w1) -> (ANumber.of(0));
            return Function4x1.<ANumber, ANumber, ANumber, ANumber, ANumber>of(function);
        }
        else
        {
            ...
            Function4x1IF<ANumber, ANumber, ANumber, ANumber, ANumber> function = getFirstOrderDerivativeFunction(f.getFunctionCasted(), x, y, w, h);

            if(orderOfDerivative == 2)
            {
                function = getFirstOrderDerivativeFunction(function, x, y, w, h);
            }
    ...
    private static Function4x1IF<ANumber, ANumber, ANumber, ANumber, ANumber> getFirstOrderDerivativeFunction(Function4x1IF<ANumber, ANumber, ANumber, ANumber, ANumber> f, ANumber x, ANumber y, ANumber w, ANumber h)
    {
        return (ANumber x1, ANumber y1, ANumber z, ANumber w1) -> (f.run(x, y, z.addGET(h), w).subtractGET(f.run(x, y, z, w)).divideGET(h));
    }
}