...
public class TransitionStateCheckingFunction extends Orion implements MathObject
{
    private OrionFunction2x1<State, Object, State> function;


    public TransitionStateCheckingFunction(OrionFunction2x1<State, Object, State> function)
    {
    ...
    public static TransitionStateCheckingFunction of(OrionFunction2x1<State, Object, State> function)
    {
        return new TransitionStateCheckingFunction(function);
    }
