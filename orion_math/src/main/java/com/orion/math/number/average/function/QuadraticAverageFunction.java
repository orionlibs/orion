...
public class QuadraticAverageFunction extends Orion
{
    ...
    static
    {
        Function1x1IF<List<ANumber>, ANumber> f1 = (List<ANumber> values) -> (AverageService.getQuadraticAverage(values));
        formula = Function1x1.of(f1);
        Function2x1IF<List<ANumber>, Integer, ANumber> f2 = (List<ANumber> values, Integer precision) -> (AverageService.getQuadraticAverage(values, precision));
