...
public class ArithmeticAverageFunction extends Orion
{
    private static Function1x1<List<ANumber>, ANumber> formula;
    static
    {
        Function1x1IF<List<ANumber>, ANumber> f = (List<ANumber> values) -> (AverageService.getArithmeticAverage(values));
