...
public class SubtractFromMatrixOfFunction1x1ColumnTask extends Orion
{
    public static void run(MatrixOfFunction1x1 x, int columnIndex, ANumber y)
    {
        ...
        column.forAllIndices(i -> column.set(i, column.get(i).subtract(y)));
    }
    ...
    public static void run(MatrixOfFunction1x1 x, int columnIndex, VectorOfFunction1x1 y)
    {
        ...
        column.forAllIndices(i -> column.set(i, column.get(i).subtract(y.get(i))));
    }
}