...
public class BackwardSubstitutionFunction extends Orion
{
    private static Function2x1<Matrix, Vector, Vector> formula;
    static
    {
        formula = Function2x1.of((Matrix matrix, Vector vector) -> LinearAlgebraService.doBackwardSubstitution(matrix, vector));
    }
