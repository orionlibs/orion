...
public class GetUnionOfGenericMultiSetsTask extends Orion
{
    @SuppressWarnings(
    {"unchecked", "rawtypes"})
    public static GenericMultiSet run(GenericMultiSet set1, OrionSet<Object> set2)
    {
        ...
        {
            result = ((OrionHashMultiSet<Object>)set1.getElements()).getUnion((OrionHashMultiSet)set2);
        }
        else
        {
            result = ((OrionHashMultiSet<Object>)set1.getElements()).getUnion(OrionHashMultiSet.of(set2));
        }
