...
public class GetIntersectionOfGenericMultiSetsTask extends Orion
{
    @SuppressWarnings(
    {"unchecked", "rawtypes"})
    public static GenericMultiSet run(GenericMultiSet set1, OrionSet<Object> set2)
    {
        ...
        {
            result = ((OrionHashMultiSet<Object>)set1.getElements()).getIntersection((OrionHashMultiSet)set2);
        }
        else
        {
            result = ((OrionHashMultiSet<Object>)set1.getElements()).getIntersection(OrionHashMultiSet.of(set2));
        }
