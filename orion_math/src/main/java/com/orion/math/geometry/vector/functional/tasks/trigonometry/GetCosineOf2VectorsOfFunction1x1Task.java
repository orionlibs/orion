...
public class GetCosineOf2VectorsOfFunction1x1Task extends Orion
{
    public static Function1x1<ANumber, ANumber> run(VectorOfFunction1x1 x, VectorOfFunction1x1 y, int precision)
    {
        ...
        {
            return x.getDotProduct(y).divide(x.getMagnitude(precision).multiply(y.getMagnitude(precision)));
        }
