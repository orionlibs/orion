package com.orion.core.string;

import com.orion.core.abstraction.OrionService;
import com.orion.core.exception.Assert;
import com.orion.core.string.tasks.ArePermutationsOfEachOtherTask;
import com.orion.core.string.tasks.ConcatenateSeparatedBySpaceTask;
import com.orion.core.string.tasks.ConcatenateTask;
import com.orion.core.string.tasks.ConnectStringsByStringTask;
import com.orion.core.string.tasks.ConvertFirstCharacterOfEachWordToUppercaseTask;
import com.orion.core.string.tasks.ConvertFirstCharacterToUppercaseTask;
import com.orion.core.string.tasks.ConvertToCommaAndSpaceSeparatedStringTask;
import com.orion.core.string.tasks.ConvertToCommaSeparatedStringTask;
import com.orion.core.string.tasks.CopyFromTheBeginningUpToTask;
import com.orion.core.string.tasks.CopyStringTask;
import com.orion.core.string.tasks.DeleteCharacterFromTheEndTask;
import com.orion.core.string.tasks.DeleteLineSeparatorFromTheEndTask;
import com.orion.core.string.tasks.DoesMatchRegularExpressionTask;
import com.orion.core.string.tasks.DoesStringEndWithAnyTask;
import com.orion.core.string.tasks.DoesStringStartWithAnyTask;
import com.orion.core.string.tasks.GenerateRandomNumericCodeTask;
import com.orion.core.string.tasks.GenerateRandomStringTask;
import com.orion.core.string.tasks.GetAlphabeticalValueTask;
import com.orion.core.string.tasks.GetHashCodeTask;
import com.orion.core.string.tasks.GetLongestCommonSubstringTask;
import com.orion.core.string.tasks.GetSimilarityPercentageBetweenTask;
import com.orion.core.string.tasks.IsLastCharacterAWhitespaceTask;
import com.orion.core.string.tasks.IsOnlyAlphabeticalTask;
import com.orion.core.string.tasks.IsOnlyAlphabeticalWithHyphensAndSpacesTask;
import com.orion.core.string.tasks.IsOnlyAlphabeticalWithHyphensTask;
import com.orion.core.string.tasks.PermuteStringTask;
import com.orion.core.string.tasks.PrefixStringTask;
import com.orion.core.string.tasks.SeparateByStringTask;
import com.orion.core.string.tasks.ShuffleStringTask;
import com.orion.core.string.tasks.SurroundWithStringTask;
