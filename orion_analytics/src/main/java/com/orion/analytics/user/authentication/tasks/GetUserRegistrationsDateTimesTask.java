...
public class GetUserRegistrationsDateTimesTask extends Orion
{
    public static List<AnalyticsRegistrationModel> run()
    {
        List<AnalyticsRegistrationModel> models = new ArrayList<>();
        List<OrionUserModel> results = UserAccountService.getUserRegistrationDateTimes();
