...
public class GetUserRegistrationsDateTimesByAuthorityForDateRangeTask extends Orion
{
    public static List<AnalyticsRegistrationModel> run(String authority, String startDate, String endDate) throws InvalidDateException
    {
        ...
        List<OrionUserModel> results = UserAccountService.getUserRegistrationDateTimesByAuthorityForDateRange(authority, date1String, date2String);
