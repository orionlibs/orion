...
public class GetUserLoginsDateTimesForAuthorityForDateRangeTask extends Orion
{
    public static List<AnalyticsLoginModel> run(String authority, String startDate, String endDate) throws InvalidDateException
    {
        ...
        List<OrionUserLoginModel> results = OrionUserLoginsDAO.getDateTimesByAuthorityForDateRange(authority, date1String, date2String);
