...
public class GetUserLoginsDateTimesForDateRangeTask extends Orion
{
    public static List<AnalyticsLoginModel> run(String startDate, String endDate) throws InvalidDateException
    {
        ...
        List<OrionUserLoginModel> results = OrionUserLoginsDAO.getDateTimesForDateRange(date1String, date2String);
