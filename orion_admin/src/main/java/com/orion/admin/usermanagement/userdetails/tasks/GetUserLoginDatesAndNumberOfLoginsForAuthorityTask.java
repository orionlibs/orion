...
public class GetUserLoginDatesAndNumberOfLoginsForAuthorityTask extends Orion
{
    public static List<List<Long>> run(String authority, List<DateTime> loginDateTimes)
    {
        ...
        {
            long numberOfLoginsForDate = OrionUserLoginsDAO.getNumberOfLoginsByAuthorityAndDate(authority, datetime.getDate().getDateStringSplitByHyphensYearFirst());
