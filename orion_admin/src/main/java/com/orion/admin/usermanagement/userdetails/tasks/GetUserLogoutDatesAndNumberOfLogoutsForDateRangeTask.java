...
public class GetUserLogoutDatesAndNumberOfLogoutsForDateRangeTask extends Orion
{
    public static List<List<Long>> run(List<DateTime> logoutDateTimes)
    {
        ...
        {
            long numberOfLogoutsForDate = OrionUserLogoutsDAO.getNumberOfLogoutsByDate(datetime.getDate().getDateStringSplitByHyphensYearFirst());
