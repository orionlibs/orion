...
public class GetUserRegistrationDatesAndNumberOfRegistrationsByAuthorityTask extends Orion
{
    public static List<List<Long>> run(String authority, List<DateTime> registrationDateTimes)
    {
        ...
        {
            long numberOfRegistrationsForDate = UserAccountService.getNumberOfUserRegistrationsByAuthorityAndDate(authority, datetime.getDate().getDateStringSplitByHyphensYearFirst());
