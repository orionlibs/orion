...
public class CreateAndSaveEmailValidationCodeTask extends Orion
{
    public static String run(String userID)
    {
        Assert.notEmpty(userID, "The userID input cannot be null/empty.");
        String UUIDBase64Encoded = generateUUIDWithoutHyphensBase64ForURLEncoded();
        buildAndSaveEmailValidationCodesModel(UUIDBase64Encoded, userID);
        return UUIDBase64Encoded;
    }
    ...
    private static void buildAndSaveEmailValidationCodesModel(String UUIDBase64Encoded, String userID)
    {
        ...
        emailValidationCodeModel.setEmailValidationCode(UUIDBase64Encoded);
